const __pluginConfig =  {
  "name": "windy-plugin-gps-tracker",
  "version": "1.0.0",
  "icon": "📍",
  "title": "GPS Tracker for Windy",
  "description": "Sigue la ubicación GPS y muestra lluvias en Windy",
  "author": "Tu Nombre o Empresa",
  "desktopUI": "rhpane",
  "mobileUI": "fullscreen",
  "built": 1742452933413,
  "builtReadable": "2025-03-20T06:42:13.413Z",
...
(function (bcast) {
	...
	function instance($$self, $$props, $$invalidate) {
		...
		return [title, onopen, click_handler];
	}

	class Plugin extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance, create_fragment, safe_not_equal, { onopen: 1 });
		}
